 ...
 */
public class ProfileFragmentExecutor extends Fragment {
    private Handler handler = new Handler();
    private LinearLayout infoLayout;
    private LinearLayout socialLayout;
    private static Executor executor = Executors.newSingleThreadExecutor();

    public static ProfileFragmentExecutor newInstance() {
        ProfileFragmentExecutor fragment = new ProfileFragmentExecutor();
        return fragment;
    }

    public ProfileFragmentExecutor() {
